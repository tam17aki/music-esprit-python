...
-  **`examples/`**: A directory containing example scripts that demonstrate how to use the library.
    -   `run_comparison.py`: The main demonstration script that runs a comparative analysis of all major algorithms. It can be used as a starting point for your own experiments.
